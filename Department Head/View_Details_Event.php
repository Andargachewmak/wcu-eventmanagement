...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['id'])) {
    ...
    $sql = "SELECT events.event_id, events.title, events.description, events.event_date, events.event_time, events.location, user.fname AS created_by, events.created_at 
    FROM events 
...
<body>
    <div class="container">
        ...
        <div class="event-details">
            ...
            <textarea id="description" name="event_description" rows="12" cols="50" disabled><?php echo htmlspecialchars($description); ?></textarea>
            ...
            <input type="text" id="created_by" name="created_by" value="<?php echo htmlspecialchars($created_by); ?>" disabled>
