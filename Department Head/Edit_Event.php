...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['update_event'])) {
    ...
    $sql = "UPDATE events SET title = ?, description = ?, event_date = ?, event_time = ?, location = ?, created_by = ?, created_at = created_at, updated_at = ? WHERE event_id = ?";
...
<head>
    ...
    <style>
        ...
        /* CSS for Update Event button */
        button[name="update_event"] {
        ...
        button[name="update_event"]:hover {
