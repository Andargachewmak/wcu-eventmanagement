        ...
        <div class = "content"><!--body content holder-->
            ...
            <div class="container">
                <div class="col-md-6 contacts">
                    ...
                    <p>
                        <span class="glyphicon glyphicon-envelope"></span> Email: abraham@gmail.com<br>
    
                        <span class="glyphicon glyphicon-phone"></span> Mobile: 0941492182
                    </p>
                </div>
                <div class="col-md-6 contacts">
                    <h1 style="color:#000080 ; font-size:42px ; font-style:bold "><span class="glyphicon glyphicon-user"></span> Bhavana G</h1>
                    <p>
                        <span class="glyphicon glyphicon-envelope"></span> Email: andargachewmekonn09@gmail.com<br>
    
                        <span class="glyphicon glyphicon-phone"></span> Mobile: 0954904064
                    </p>
                </div>
            </div>
