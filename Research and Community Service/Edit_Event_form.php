...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "UPDATE events SET title = ?, description = ?, event_date = ?, event_time = ?, location = ?, created_by = ?, created_at = ? WHERE event_id = ?";
...
$sql = "SELECT events.event_id, events.title, events.event_date, events.event_time, events.description, events.location, user.fname AS created_by, events.created_at 
FROM events 
                ...
                if (!empty($events)) {
                    foreach ($events as $row) {
                        echo "<tr>
                            ...
                            <td>
                                <button class='button_edit' onclick='editEvent(" . $row["event_id"] . ")'>Edit</button>
                            </td>
                            <td>
                                <button class='button_del' onclick='confirmDelete(" . $row["event_id"] . ")'>Delete</button>
                            </td>
                        </tr>";
                    }
                } else {
